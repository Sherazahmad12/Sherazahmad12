...
def TranscribeCommand():
    ...
    audioFile = "C:\\Users\\SherazAhmad\\Desktop\\Azure AI 102\\AI-102-AIEngineer\\07-speech\\Python\\speaking-clock\\yourname_intro.wav"
    playsound(audioFile)
...
def YourNameCall():
    try:
        ...
        audio_file_path = "yourname_intro.wav"  # Update with your recorded audio file
